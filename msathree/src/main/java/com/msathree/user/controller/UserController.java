package com.msathree.user.controller;
...
import com.msathree.user.service.UserService;
...
public class UserController {
	...
	public ModelAndView form(HttpSession httpSession) {
		...
		System.out.println("3 SESSION ID ---> " + sessionid);
		System.out.println("3 SESSION NAME ---> " + sessionname);
